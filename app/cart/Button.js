...
export default function Button() {
   ...
   return <> 
<button onclick={() => console.log("button")} className="flex  bg-white rounded-lg text-sm font-semibold text-black justify-center items-center my-3 py-2 border-dashed border-6 w-full ">
