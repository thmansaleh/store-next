...
export default function PromotionCode() {
   ...
   return <> 
<button onclick={() => console.log(1)} className="flex  bg-white rounded-lg text-sm font-semibold text-black justify-center items-center my-3 py-2 border-dashed border-4 w-full ">
