...
code.current.classList.toggle('h-20')
  ...
  <button onclick={() => console.log("7777")} className="flex  bg-white rounded-lg text-sm font-semibold text-black justify-center items-center my-3 py-2 border-dashed border-2 w-full ">
