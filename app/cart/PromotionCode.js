...
<button onClick={openInput} className="flex  bg-white rounded-lg text-sm font-semibold text-black justify-center items-center my-3 py-2 border-dashed border w-full ">
...
<div ref={inputRef} className="h-0 w-full  transition-all overflow-y-hidden">
  <div className="mt-5 flex px-4">
    <input className="flex-1 rounded-s-xl border-2 border-black p-2 focus:outline-none" placeholder="ادخل الكود" type="text"  />
