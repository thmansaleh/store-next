...
export default function PromotionCode() {
   ...
   return <> 
<Button/>
<button onClick={() => console.log(14)} className="flex  bg-white rounded-lg text-sm font-semibold text-black justify-center items-center my-3 py-2 border-dashed border-4 w-full ">
...
<div onClick={() => console.log(1)} className="h-20 w-full  transition-all overflow-y-hidden">
