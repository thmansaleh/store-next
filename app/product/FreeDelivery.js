...
return <div className="w'full border border-gray-300 rounded-lg flex  flex-wrap">
  <div className="flex  inline-block w-fit rounded-lg py-1 text-sm text-zinc-400 items-center    my-2 mx-3 ">
    <div className=" px-2 mx-2 flex border  bg-red-200 h-9 w-9 items-center justify-center rounded-full bg-white text-white border-zinc-400">
  ...
  <div className="inline-block flex w-fit rounded-lg py-1 text-sm text-zinc-400 items-center   inline-block my-2 mx-3 ">
    ...
    <span className>Free Returns</span>
  </div>
