...
return  <div className="bg-white my-3 text-sm px-4 rounded-lg flex justify-between items-center w-full max-w-lg">
    
        <div className="flex items-center gap-x-2">
            <svg className="h-6 w-6 fill-emerald-600" >
            ...
            <div>
                <p className="font-semibold text-gray-800">إرجاع مجاني</p>
                {/* <p className="text-sm text-gray-600">لمدة 90 يوم</p> */}
            </div>
        </div>
