...
<div ref={modal} className=" hidden bg-gray-100 bg-opacity-75 transition-all modal-container flex overflow-y-auto overflow-x-hidden fixed  z-40 inset-0 justify-center items-center   bottom-0 bg-gray-400 max-h-full">
