...
return <Link key={i} href="/product?product_id=1" className=" inline-block relative rounded-lg   shadow-md overflow-hidden  w-36 bg-white   h-fit " >
    <div className="  "><img className="h-40 w-full object-contain " src="https://cdn.dummyjson.com/product-images/1/thumbnail.jpg" /></div><span className=" line-clamp-2 text-sm my-2 px-2">An apple mobile which is nothing like apple</span>
