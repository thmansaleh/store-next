...
<div onClick={closeModal} ref={inputRef} className="hidden   transition-all modal-container flex overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 bottom-0 bg-gray-100 max-h-full">
