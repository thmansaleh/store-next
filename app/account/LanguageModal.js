...
<div onClick={closeModal} ref={inputRef} className="hidden bg-opacity-75 bg-gray-200 transition-all modal-container flex overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 bottom-0  max-h-full">
